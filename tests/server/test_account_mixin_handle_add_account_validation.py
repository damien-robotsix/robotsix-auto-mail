"""Unit tests for ``AccountService.handle_add_account()`` validation and
error paths."""
...
class TestHandleAddAccountValidation:
    """Tests for ``AccountService.handle_add_account()`` validation and
    error paths."""

    def _setup_post(self, handler: _AccountServiceContext, body_str: str) -> None:
        """Configure context mocks for a POST with the given body."""
