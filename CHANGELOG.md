...
- Clear repo-wide ruff lint debt (remove unused `# noqa: S310` directives) and fix module-registration check (register unclaimed changelog fragment, remove stale `changelog.d/*.md` glob).
