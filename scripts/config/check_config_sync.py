...
FIELD_TO_YAML: dict[str, str] = {
    ...
    "calendar_transport": "calendar.transport",
    "calendar_broker_host": "calendar.broker_host",
    "calendar_broker_port": "calendar.broker_port",
    "calendar_broker_tls_ca": "calendar.broker_tls_ca",
    "calendar_broker_client_cert": "calendar.broker_client_cert",
    "calendar_broker_client_key": "calendar.broker_client_key",
    "calendar_broker_token": "calendar.broker_token",
...
FIELD_TO_ENV: dict[str, str] = {
    ...
    "calendar_enabled": "MAIL_CALENDAR_ENABLED",
    "calendar_transport": "CALENDAR_TRANSPORT",
    "calendar_broker_host": "CALENDAR_BROKER_HOST",
    "calendar_broker_port": "CALENDAR_BROKER_PORT",
    "calendar_broker_tls_ca": "CALENDAR_BROKER_TLS_CA",
    "calendar_broker_client_cert": "CALENDAR_BROKER_CLIENT_CERT",
    "calendar_broker_client_key": "CALENDAR_BROKER_CLIENT_KEY",
    "calendar_broker_token": "CALENDAR_BROKER_TOKEN",
