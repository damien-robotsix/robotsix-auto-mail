...
def _cmd_serve(
    ...
    *default_account_id* names the account served when a request omits
    ...
    from robotsix_auto_mail.lifespan import start_board_agent, stop_board_agent
    ...
    # Optionally start the board agent (no-op when disabled or not installed).
    board_agent = start_board_agent(default.config)
